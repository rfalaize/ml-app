...
@Component({
  ...
  styleUrls: ['./charts.component.scss', './../../assets/styles/index.scss']
})
export class ChartsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.lineChartBox = new Chart('line-chart', {
      type: 'line',
      data: {
    ...
    // @Bar Charts
    // ------------------------------------------------------
    this.barChartBox = new Chart('bar-chart', {
      type: 'bar',
      data: {
        labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
        datasets: [{
    ...
    // @Area Charts
    // ------------------------------------------------------
    this.areaChartBox = new Chart('area-chart', {
      type: 'line',
      data: {
        labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
        datasets: [{
    ...
    // @Scatter Charts
    // ------------------------------------------------------
    this.scatterChartBox = new Chart('scatter-chart', {
      type: 'scatter',
        data: {
          datasets: [{
